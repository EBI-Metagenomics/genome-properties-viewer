...
class GenomePropertiesHierarchy {
    ...
    update_top_level_legend(){
        ...
        tll.enter().append("circle")
            ...
            .on("mouseover", d => {
                select("#info_top_level_properties").text(this.nodes[d.id].name)
            })
            .on("mouseout", () => {
...
class TaxonomyNodeManager {
    ...
    draw_nodes(visible_nodes, t){
        ...
        node_e.append("text")
            ...
            .text(text_to_node)
            .on("mouseover", (d,i,c)=>select(c[i]).text(text_to_node(d,i,c,true)))
            .on("mouseout", (d,i,c)=>select(c[i]).text(text_to_node(d,i,c,false)));
...
class GenomePropertiesViewer {
        ...
        this.svg = select(element_selector).append("svg")
            ...
            .on('wheel',()=>{
                ...
                if (event.ctrlKey || event.shiftKey){
                    this.svg.k= (this.svg.k!=null)?this.svg.k-event.deltaY/2:0;
                ...
                // PANNING-SCROLLING
                this.svg.x= (this.svg.x!=null)?this.svg.x+event.deltaX:0;
                this.svg.x = Math.max(0,
                    Math.min(this.svg.x,
                        select(".gpv-rows-group").node().getBBox().width
                        - this.options.width
                        - this.options.margin.left
                    )
                );

                this.svg.y= (this.svg.y!=null)?this.svg.y+event.deltaY:0;
    ...
    update_total_per_organism_panel(time=0) {
        ...
        cells_t.enter().append("g")
            ...
            .on("mouseover", p => {
                ...
                select("#info_organism").text(`${p.key}: ${this.organism_names[p.key]}`);
    ...
    draw_bottom_panel(){
        ...
        const legend_item = this.legend_g.selectAll(".legend-item")
            .data(entries(empty_total).sort((a,b)=>a.key>b.key?-1:1), d=>d.key);
    ...
    update_viewer(zoom=false, time=0) {
        ...
        function update_row(_this){
            return function(r) {
                ...
                const gps = select(this).selectAll(".top_level_gp")
                ...
                let cells = select(this).selectAll(".cell")
                ...
                const cells_t = select(this).selectAll(".total_cell")
                    .data(["TOTAL"], d=>d);
        ...
        function mouseover(_this) {
            return function(p) {
                ...
                const data = select(this.parentNode).data();
