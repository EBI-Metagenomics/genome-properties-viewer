...
class GenomePropertiesViewer {
    ...
    load_genome_properties_file(tax_id) {
        ...
        text(`${this.options.server}${tax_id}`)
            .get((error, text) => {
                ...
                xml(this.options.server_tax.replace("{}",tax_id), (error, xml) => {
                    if (error) throw error;
    ...
    update_tree(time=0){
        ...
        this.orders = {
            tax_id: sequence(ol).sort((a, b) => this.organisms[a] - this.organisms[b]),
            org_name: sequence(ol).sort((a, b) => this.organism_names[this.organisms[a]] > this.organism_names[this.organisms[b]]?1:-1),
        ...
        const node_e = node
            ...
            .attr("transform", d => "translate(" + d.x + "," + d.y + ")" )
            .on("mouseover", d => select("#info_organism").text(`${d.label}: ${this.organism_names[d.label]}`))
            .on("mouseout", d => select("#info_organism").text(""))
            .call(drag()
                .subject(function(){
                    const g = select(this),
                ...
                .on("end", function(_this) {
                    return function (d) {
                        ...
                        select(this).transition(t).attr("transform",
                            d => "translate(" + d.x + "," + d.y + ")");
    ...
    update_top_level_legend(){
        ...
        tll.enter().append("circle")
            ...
            .on("mouseover", d => {
                select("#info_top_level_properties").text(this.gp_hierarchy.nodes[d.id].name)
            })
            .on("mouseout", d => {
