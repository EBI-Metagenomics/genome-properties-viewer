...
class GenomePropertiesViewer {
    ...
    update_viewer() {
        ...
        // Precompute the orders.
        this.orders = {
            tax_id: sequence(n).sort((a, b) => this.organisms[b] - this.organisms[a]),
            org_name: sequence(n).sort((a, b) => this.organisms[b] - this.organisms[a]),
            tree: sequence(n).sort((a, b) => this.organisms[b] - this.organisms[a]),
        };
        ...
        function update_row(_this){
            return function(r) {
                const cells = select(this).selectAll(".cell")
