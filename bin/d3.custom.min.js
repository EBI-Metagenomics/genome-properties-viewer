...
class GenomePropertiesViewer {
    ...
    update_viewer() {
        ...
        this.orders = {
            ascending: sequence(n).sort((a, b) => this.organisms[b] - this.organisms[a]),
            descending: sequence(n).sort((a, b) => this.organisms[a] - this.organisms[b]),
            length: sequence(n).sort((a, b) => this.organisms[a].length -this.organisms[b].length),
        };
            ...
            .call(drag()
                ...
                .on("end", function(t) {
                    ...
                    return function (e) {
                        ...
                        select(this).transition(t).attr("y", _this.x.bandwidth() / 2);
