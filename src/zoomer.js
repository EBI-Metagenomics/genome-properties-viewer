...
export default class ZoomPanel {
    ...
    draw_panel(){
        this.zoom_panel = this.container.append("g")
            .attr("class", "gpv-zoomer")
            .attr("transform", `translate(${this.x}, ${this.y})`);
        ZoomPanel.add_button(this.zoom_panel, "+", this.centerX, this.top,this.r)
        ...
        this.zoomBar = this.zoom_panel.append("rect")
            ...
            .style("fill", "darkgrey")
            .call(d3.drag()
                .on("drag", this.function_slide));

        ZoomPanel.add_button(this.zoom_panel, "-", this.centerX,this.top + 2*this.r + 2*this.padding +this.scrollH,this.r)
